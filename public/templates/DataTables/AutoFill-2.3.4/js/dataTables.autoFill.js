...
/**
 * @summary     AutoFill
 * @description Add Excel like click and drag automobile-fill options to DataTables
 * @version     2.3.4
...
/** 
 * AutoFill provides Excel like automobile-fill features for a DataTable
 *
 * @class AutoFill
 * @constructor
...
AutoFill.defaults = {
	...
	/** @type {column-selector} Columns to provide automobile fill for */
	columns: '', // all
