 ...
 * @UniqueEntity(fields={"libelle"}, message="Ce département existe déjà")
 */
class Departement
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Client::class, mappedBy="departement")
     */
    private $clients;
